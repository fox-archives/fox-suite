...
export const groupNpmPackageMeta = {
  ...
  keys: [
    ...
    { key: 'publishConfig', type: 'lone' },
    { key: 'preferGlobal', type: 'lone' },
  ]
}
...
export const groupVsCodeExtensionMeta = {
  location: '',
  keys: [
    { key: 'displayName', type: 'lone' },
    { key: 'extensionPack', type: 'lone' },
    { key: 'categories', type: 'lone' },
    { key: 'extensionDependencies' },
    { key: 'icon', type: 'lone' },
    { name: 'badges', type: 'lone' },
    { key: 'galleryBanner' },
    { key: 'preview', type: 'lone' },
    { key: 'markdown', type: 'lone' },
    { key: 'contributes', type: 'lone' },
    { key: 'activationEvents', type: 'lone' },
    { key: 'qna', type: 'lone' },
    { key: 'publisher', type: 'lone' },
  ]
}
